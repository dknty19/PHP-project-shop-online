                            ...
                            <div class="blog-body">
                                <form id="defaultForm" method="post" action="index.php" 
                                    ...
                                    <fieldset>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-9">
                                                <select name="category_id" class="form-control">
                                                    ...
                                                    ?>
                                                    <option value="<?= $crow['category_id']?>"
                                                            <?= $row['category_id'] == $crow['category_id']?'selected':''?>>
                                                        <?= $crow['name']?>
                                                    </option>
                                                    <?php 
                                                    endforeach;
                                        ...
                                        <div class="form-group">
                                            <label class="col-lg-3 control-label">Produced Date</label>
                                            <div class="col-lg-9">
                                                <input type="date" class="form-control" name="produced_date"
                                                        value="<?= empty($row['produced_date'])?'':$row['produced_date'] ?>"/>
                                            </div>
                                        </div>
                                        <div class="form-group">

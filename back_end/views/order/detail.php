                    ...
                    <div class="col-md-12 col-sm-12 col-sx-12">
                        <div class="panel no-margin">
                            <div class="panel-heading">
                                <h4 class="panel-title">Product ID: <span class="text-danger">- 00975</span>
                                </h4>
                                <i class="custom-text">Produced Date - <small class="text-success">20:08:2014</small></i>
                            </div>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td style="width:50%" class="left-align-text">
                                                    ...
                                                    <span class="label label-info"><?= $row['entered_date']?></span>  <br>
                                ...
                                <div class="row">
                                    <div class="col-md-12 col-sm-12 col-sx-12">
                                        <div class="pull-right">
                                            <a href="index.php?action=product_edit&product_id=<?= $row['product_id']?>" type="button" class="btn btn-warning">
                                                <i class="fa fa-edit"></i> 
                                                <span class="hidden-xs">Edit</span>
                                            </a>
                                            <a href="#" type="button" class="btn btn-danger"
                                               onclick="confirmDelete('index.php?action=product_delete?product_id=<?= $row['product_id']?>', 'product');">
